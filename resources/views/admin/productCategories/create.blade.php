                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.product_categories.index')}}"> الاقسام
                                        المنتج </a>
                                </li>
                                <li class="breadcrumb-item active">إضافة قسم منتج
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> إضافة قسم منتج </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.product_categories.store')}}"
                                              method="POST"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            ...
                                                            @error("active")
                                                            <span class="text-danger"> لابد من اختيار حالة </span>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                </div>
